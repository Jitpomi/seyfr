...
Seyfr is proprietary freeware. The application binaries are freely available for download and use, but the source code is proprietary and not publicly available. See the [LICENSE](./LICENSE) file for details.
